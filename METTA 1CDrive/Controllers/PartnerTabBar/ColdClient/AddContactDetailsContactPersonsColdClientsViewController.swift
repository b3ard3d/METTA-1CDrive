//
//  AddContactDetailsContactPersonsColdClientsViewController.swift
//  salesManager
//
...
final class AddContactDetailsContactPersonsColdClientsViewController: UIViewController {
    ...
    func saveRequestData(сontactPersonsColdClientsUUID: String, jsonArray: [[String: String]]) {
        let defaults = UserDefaults.standard
        defaults.set(jsonArray, forKey: "SavedJsonContactDetailsContactPersonsColdClientsData")
    }
    ...
    @objc func saveButtonClicked() {
        ...
        if tel.isEmpty && email.isEmpty {
            ...
            if jsonArray.count > 0 {
                saveRequestData(сontactPersonsColdClientsUUID: selectedUUID ?? "", jsonArray: jsonArray)
...
extension AddContactDetailsContactPersonsColdClientsViewController: UITextFieldDelegate {
