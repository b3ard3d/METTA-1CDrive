...
final class AddContactDetailsColdClientsViewController: UIViewController {
    ...
    func saveRequestData(jsonArray: [[String: String]]) {
        ...
        defaults.set(jsonArray, forKey: "SavedJsonContactDetailsColdClientsData")
    }
...
extension AddContactDetailsColdClientsViewController: UITextFieldDelegate {
