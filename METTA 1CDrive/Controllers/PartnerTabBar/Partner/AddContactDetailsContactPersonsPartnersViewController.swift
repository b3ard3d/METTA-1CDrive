...
final class AddContactDetailsContactPersonsPartnersViewController: UIViewController {
    ...
    func saveRequestData(сontactPersonsPartnersUUID: String, jsonArray: [[String: String]]) {
        let defaults = UserDefaults.standard
        defaults.set(jsonArray, forKey: "SavedJsonContactDetailsContactPersonsPartnersData")
    }
    ...
    @objc func saveButtonClicked() {
        ...
        if tel.isEmpty && email.isEmpty {
            ...
            if jsonArray.count > 0 {
                saveRequestData(сontactPersonsPartnersUUID: selectedUUID ?? "", jsonArray: jsonArray)
...
extension AddContactDetailsContactPersonsPartnersViewController: UITextFieldDelegate {
